...
import GameView from './PerfectoGameView';
      ...
      <div className="w-full max-w-xl space-y-6">
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-6 text-slate-900 text-left">
            ...
            <div className="space-y-1 flex-1">
              ...
              <p className="text-slate-400 text-sm sm:text-base font-bold italic leading-tight">Սովորիր օգտագործել անցյալ ժամանակը:</p>
            </div>
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-6 text-white text-left">
            ...
            <div className="space-y-1 flex-1">
              <h3 className="text-2xl sm:text-4xl font-black italic uppercase tracking-tighter leading-tight group-hover:text-indigo-400 transition-colors">ԽԱՂ</h3>
              <p className="text-white/70 text-sm sm:text-base font-bold italic leading-tight">Ստուգիր քո գիտելիքները հիմա:</p>
            </div>
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-100 selection:text-indigo-600 overflow-x-hidden">
      ...
      <footer className="px-4 py-24 text-center pb-32">
        <p className="text-[10px] font-black text-slate-300 uppercase tracking-[0.5em]">
           &copy; 2026 ԻՍՊԱՆԵՐԵՆԻ ՈՒՍՈՒՑՈՒՄ: PRETÉRITO PERFECTO
        </p>
      </footer>
    </div>
  );
